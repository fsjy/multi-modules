...
public class BpmnXMLConverter implements BpmnXMLConstants {
  ...
  protected static final Logger LOGGER = LoggerFactory.getLogger(org.activiti.bpmn.converter.BpmnXMLConverter.class);
  ...
  protected SubProcessParser subProcessParser = new SubProcessParser();
    ...
    // tasks
        ...
        // 对BusinessRuleTask标签的支持只允许LocalBusinessRuleTaskXMLConverter的方式
	  // addConverter(new BusinessRuleTaskXMLConverter());

	    // Add by Yanglu 2017.11.7
        // 增加对LocalRusinessRuleTask的解析
	    addConverter(new LocalBusinessRuleTaskXMLConverter());
  ...
  protected Schema createSchema() throws SAXException {
    ...
    if (schema == null) {
      schema = factory.newSchema(org.activiti.bpmn.converter.BpmnXMLConverter.class.getClassLoader().getResource(BPMN_XSD));
    }
