...
public class LocalBusinessRuleTaskJsonConverter extends BaseBpmnJsonConverter {
    ...
    public static void fillJsonTypes(Map<String, Class<? extends BaseBpmnJsonConverter>> convertersToBpmnMap) {
        convertersToBpmnMap.put(STENCIL_TASK_BUSINESS_RULE, LocalBusinessRuleTaskJsonConverter.class);
    }

    public static void fillBpmnTypes(Map<Class<? extends BaseElement>, Class<? extends BaseBpmnJsonConverter>> convertersToJsonMap) {
        convertersToJsonMap.put(LocalBusinessRuleTask.class, LocalBusinessRuleTaskJsonConverter.class);
    }
    ...
    protected void convertElementToJson(ObjectNode propertiesNode, BaseElement baseElement) {
        LocalBusinessRuleTask ruleTask = (LocalBusinessRuleTask) baseElement;
        ...
        // Add by Yanglu 2017.11.9 支持json读取新的implementation
        if (ImplementationType.IMPLEMENTATION_TYPE_DELEGATEEXPRESSION.equals(ruleTask.getImplementationType())) {
            propertiesNode.put(PROPERTY_SERVICETASK_DELEGATE_EXPRESSION, ruleTask.getImplementation());
            propertiesNode.put(PROPERTY_SERVICETASK_DELEGATE_EXPRESSION,ruleTask.getImplementation());
        }
    ...
    protected FlowElement convertJsonToElement(JsonNode elementNode, JsonNode modelNode, Map<String, JsonNode> shapeMap) {
        LocalBusinessRuleTask task = new LocalBusinessRuleTask();
        ...
        // Add by Yanglu 2017.11.9
        if (StringUtils.isNotEmpty(getPropertyValueAsString(PROPERTY_SERVICETASK_DELEGATE_EXPRESSION, elementNode))) {
